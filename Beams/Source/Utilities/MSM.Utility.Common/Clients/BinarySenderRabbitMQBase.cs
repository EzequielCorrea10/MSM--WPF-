...
namespace MSM.Utility.Common.Clients
{
    ...
    public class BinarySenderRabbitMQBase : SenderRabbitMQBase
    {
        #region constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="BinarySenderRabbitMQBase"/> class.
        /// </summary>
        /// <param name="source"></param>
        /// <param name="clientname"></param>
        /// <param name="default_queue_name"></param>
        public BinarySenderRabbitMQBase(string source, string clientname, string default_queue_name)
        ...
        /// <param name="default_queue_name"></param>
        public BinarySenderRabbitMQBase(string source, string clientname, string virtual_host, string default_queue_name)
        ...
        public BinarySenderRabbitMQBase(string source, string clientname, string default_queue_name, string username, string password)
        ...
        /// <param name="username"></param>
        /// <param name="password"></param>
        public BinarySenderRabbitMQBase(string source, string clientname, string virtual_host, string default_queue_name, string username, string password)
        ...
        /// <param name="username"></param>
        /// <param name="password"></param>
        public BinarySenderRabbitMQBase(string source, string clientname, string ip_address, string virtual_host, string default_queue_name, string username, string password)
        ...
        /// <param name="username"></param>
        /// <param name="password"></param>
        public BinarySenderRabbitMQBase(string source, string clientname, string ip_address, int port, string virtual_host, string default_queue_name, string username, string password)
        ...
        protected bool Send<T>(string username, T data_send)
            where T : class
        {
            BinaryMsgHeaderSend header_send = new BinaryMsgHeaderSend();
            header_send.version = Janus.Rodeo.Windows.Library.UI.Common.Constant.MessageConstant.VERSION;
            header_send.source = this._source;
            header_send.author = new BinaryMsgAuthor();
