...
ALTER TABLE [common].[Rodeo_Locations]  WITH CHECK ADD  CONSTRAINT [FK_Rodeo_Locations_MSM_Location_Groups] FOREIGN KEY([IdLocationGroup]) REFERENCES [common].[MSM_Location_Groups] ([IdLocationGroup])
GO

ALTER TABLE [common].[Rodeo_Locations] CHECK CONSTRAINT [FK_Rodeo_Locations_MSM_Location_Groups]
GO

ALTER TABLE [common].[Rodeo_Locations]  WITH CHECK ADD  CONSTRAINT [FK_Rodeo_Locations_MSM_Location_Ranges] FOREIGN KEY([IdLocationRange]) REFERENCES [common].[MSM_Location_Ranges] ([IdLocationRange])
GO
