...
ALTER TABLE [tracking].[Rodeo_Pieces]  WITH CHECK ADD  CONSTRAINT [FK_Rodeo_Pieces_MSM_Pick_Lists] FOREIGN KEY([IdPickList]) REFERENCES [tracking].[MSM_Pick_Lists] ([IdPickList])
GO

ALTER TABLE [tracking].[Rodeo_Pieces] CHECK CONSTRAINT [FK_Rodeo_Pieces_MSM_Pick_Lists]
GO
