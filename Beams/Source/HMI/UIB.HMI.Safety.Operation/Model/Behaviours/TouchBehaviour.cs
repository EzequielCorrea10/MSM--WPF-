...
namespace MSM.HMI.Safety.Operation.Behaviours
{
        ...
        static void CalculatePosition(ScrollViewer target, MouseCapture capture)
        {
            try
            {
                ...
                if (layout_width > 0 && layout_height > 0)
                {
                    ...
                    //    {
                    //        initial_pos_x = MSM.HMI.Safety.Operation.Converters.LayoutLeftConverter.GetRealPosition((capture.InitialPoint.X + scaleZoom.Value.OffsetX / (scaleZoom.ScaleX )), layout_width);
                    //        initial_pos_y = MSM.HMI.Safety.Operation.Converters.LayoutTopConverter.GetRealPosition((capture.InitialPoint.Y + scaleZoom.Value.OffsetY  / (scaleZoom.ScaleY )) , layout_height);
                    //        end_pos_x = MSM.HMI.Safety.Operation.Converters.LayoutLeftConverter.GetRealPosition((capture.EndPoint.X + scaleZoom.Value.OffsetX / (scaleZoom.ScaleX )) , layout_width);
                    //        end_pos_y = MSM.HMI.Safety.Operation.Converters.LayoutTopConverter.GetRealPosition((capture.EndPoint.Y + scaleZoom.Value.OffsetY / (scaleZoom.ScaleY )) , layout_height);

                    //    }
                    //    else 
                    //    {
                    //        initial_pos_x = MSM.HMI.Safety.Operation.Converters.LayoutLeftConverter.GetRealPosition((capture.InitialPoint.X + capture.HorizontalOffset) / scaleZoom.ScaleX, layout_width);
                    //        initial_pos_y = MSM.HMI.Safety.Operation.Converters.LayoutTopConverter.GetRealPosition((capture.InitialPoint.Y + capture.VerticalOffset) / scaleZoom.ScaleY, layout_height);
                    //        end_pos_x = MSM.HMI.Safety.Operation.Converters.LayoutLeftConverter.GetRealPosition((capture.EndPoint.X + capture.HorizontalOffset) / scaleZoom.ScaleX, layout_width);
                    //        end_pos_y = MSM.HMI.Safety.Operation.Converters.LayoutTopConverter.GetRealPosition((capture.EndPoint.Y + capture.VerticalOffset) / scaleZoom.ScaleY, layout_height);

                    //    }

                    //    //double initial_pos_x = MSM.HMI.Safety.Operation.Converters.LayoutLeftConverter.GetRealPosition((capture.InitialPoint.X + capture.HorizontalOffset) / scaleZoom.ScaleX, layout_width);
                    //    //double initial_pos_y = MSM.HMI.Safety.Operation.Converters.LayoutTopConverter.GetRealPosition((capture.InitialPoint.Y + capture.VerticalOffset) / scaleZoom.ScaleY, layout_height);
                    //    //double end_pos_x = MSM.HMI.Safety.Operation.Converters.LayoutLeftConverter.GetRealPosition((capture.EndPoint.X + capture.HorizontalOffset) / scaleZoom.ScaleX, layout_width);
                    //    //double end_pos_y = MSM.HMI.Safety.Operation.Converters.LayoutTopConverter.GetRealPosition((capture.EndPoint.Y + capture.VerticalOffset) / scaleZoom.ScaleY, layout_height);
